  ...
  public  class AccountingSupplierDtos
    {
        ...
        //Navigation Property
        public virtual ICollection<AccountingPurchaseOrderDtos> SupplierPurchaseOrder { get; set; }
        public virtual ICollection<AccountingPurchaseInvoiceDtos> SupplierPurchaseInvoice { get; set; }
    }
}
