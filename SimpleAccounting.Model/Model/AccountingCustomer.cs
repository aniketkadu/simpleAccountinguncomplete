...
{
   public class AccountingCustomer : AuditableEntity<long>
    {
        ...
        //Navigation Property
        public virtual ICollection<AccountingSalesOrder> CustomerSalesOrder { get; set; }
        public virtual ICollection<AccountingSalesInvoice> CustomerSalesInvoice { get; set; }
